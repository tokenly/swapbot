...
class ResetSwapCommand extends Command {
     ...
     * @var string
     */
    protected $name = 'swapbot:reset-swap';
     ...
     * @var string
     */
    protected $description = 'Resets a Swap to a ready state.  This will send the swap or refund transaction again.';
    ...
    public function fire()
    {
        try {
            ...
            $swap_repository->executeWithLockedSwap($swap, function($locked_swap) {
                ...
                $locked_swap->stateMachine()->triggerEvent(SwapStateEvent::SWAP_RESET);
            });
