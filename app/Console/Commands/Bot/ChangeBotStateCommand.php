...
class ChangeBotStateCommand extends Command {
    ...
    protected function configure()
    {
        ...
        $this
            ...
            ->setHelp(<<<EOF
Changes a bot's state by triggering a state change event (monthlyFeePaid, botFueled, fuelExhausted, paymentExhausted, paid, startShutdown, completeShutdown, revived).
EOF
        );
    }
