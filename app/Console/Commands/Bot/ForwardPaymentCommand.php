...
class ForwardBotCommand extends Command {
    ...
    public function fire()
    {
        ...
        if ($is_dry_run) {
            ...
            if ($do_payment) {
                $this->comment("Forwarding all assets for payment address {$bot['payment_address']}");
            ...
            if ($do_public) {
                $this->comment("Forwarding all assets for public address {$bot['address']}");
