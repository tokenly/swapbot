(function() {
  var SwapbotChoose, SwapbotChooseItem, SwapbotComplete, SwapbotComponent, SwapbotReceive, SwapbotSendItem, SwapbotWait, botEventWatcher, swapbot, util;
  ...
  SwapbotComponent = React.createClass({
    ...
    render: function() {
      ...
      return React.createElement("div", {
        ...
        "src": "http://robohash.org/siemano.png?set=set3"
      })), React.createElement("div", {
        "className": "status-dot bckg-green"
      }), React.createElement("h1", null, React.createElement("a", {
        "href": "http://raburski.com/swapbot0",
        "target": "_blank"
      }, ((_ref = this.state.bot) != null ? _ref.name : void 0)))), React.createElement("div", {
        "className": "content"
      }, (this.state.step === 'choose' ? React.createElement(SwapbotChoose, {
  ...
  SwapbotChooseItem = React.createClass({
    ...
    render: function() {
      ...
      }, swap.out, " ", React.createElement("small", null, "(x,xxxx available)")), React.createElement("p", null, "Sends ", rateDesc, "."), React.createElement("div", {
        "className": "icon-next"
      })));
    }
  });
  ...
  SwapbotChoose = React.createClass({
    ...
    render: function() {
      var offset, swap, swaps, _ref, _ref1;
      return React.createElement("div", {
        "id": "swap-step-1",
        "className": "swap-step"
      ...
      }, ((_ref = this.props.bot) != null ? _ref.description : void 0), " ", React.createElement("a", {
        "className": "more-link",
        "href": '#' + ((_ref1 = this.props.bot) != null ? _ref1.id : void 0),
        "target": "_blank"
        ...
        swaps = (_ref2 = this.props.bot) != null ? _ref2.swaps : void 0;
        if (swaps) {
          _results = [];
  ...
  SwapbotSendItem = React.createClass({
    ...
    render: function() {
      ...
      return React.createElement("li", null, React.createElement("div", {
        ...
        "id": "token-value-1"
      }, inAmount), " BTC to"), React.createElement("p", null, React.createElement("a", {
  ...
  SwapbotReceive = React.createClass({
    ...
    render: function() {
      ...
      return React.createElement("div", {
        ...
        "id": "token-available"
      }, "xxx,xxxx ", swap.out))), React.createElement("tr", null, React.createElement("td", null, React.createElement("label", {
  ...
  SwapbotWait = React.createClass({
    ...
    handleMatchedBotEvent: function(botEvent) {
      var event, matchedTxInfo, matchedTxs;
      event = botEvent.event;
    ...
    render: function() {
      ...
      return React.createElement("div", {
        ...
        "className": "dot"
      })), (this.state.matchedTxInfo != null ? React.createElement("p", null, "Received ", React.createElement("b", null, this.state.matchedTxInfo.inQty, " ", this.state.matchedTxInfo.inAsset), " from ", React.createElement("br", null), this.state.matchedTxInfo.address, ".", React.createElement("br", null), React.createElement("a", {
        ...
        for (swapId in _ref) {
          txInfo = _ref[swapId];
          _results.push(React.createElement("li", null, React.createElement("a", {
            "onClick": this.buildChooseSwapClicked(txInfo),
            "href": "#choose"
          }, React.createElement("div", {
            "className": "item-header",
            "title": "{txInfo.name}"
        ...
        "className": "rect5"
      })), (this.state.matchedTxInfo != null ? React.createElement("div", null, React.createElement("p", null, "This transaction has ", React.createElement("b", null, this.state.matchedTxInfo.confirmations, " out of ", bot.confirmationsRequired), " ", swapbot.botUtils.confirmationsWord(bot), "."), React.createElement("p", {
        "className": "msg"
      }, this.state.matchedTxInfo.msg)) : React.createElement("p", null, "Waiting for transaction.  This transaction will require ", swapbot.botUtils.confirmationsProse(bot), ".")));
    }
  });
