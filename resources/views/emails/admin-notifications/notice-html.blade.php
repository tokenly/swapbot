...
<h4>Your Swapbot Will Expire In A Couple Of Weeks</h4>
<p>&nbsp;</p>
@stop
...
<p>Your <a href="{{ $botUrl }}">Swapbot named {{ $bot['name'] }}</a> will expire in a couple of weeks.  After that, this Swapbot will not be able to process any swaps.</p>
